...
class InsertMasterFrameTargetVariablesBuilder {
  ...
  InsertMasterFrameTargetVariablesBuilder(this._dataConnect, {required  this.section,required  this.density,required  this.targetKgPerHour,});
  ...
  MutationRef<InsertMasterFrameTargetData, InsertMasterFrameTargetVariables> ref() {
    InsertMasterFrameTargetVariables vars= InsertMasterFrameTargetVariables(section: section,density: density,targetKgPerHour: targetKgPerHour,);
...
class InsertMasterFrameTargetVariables {
  ...
  @override
  int get hashCode => Object.hashAll([section.hashCode, density.hashCode, targetKgPerHour.hashCode]);
