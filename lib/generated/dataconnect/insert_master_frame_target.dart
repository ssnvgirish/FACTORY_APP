...
class InsertMasterFrameTargetVariablesBuilder {
  ...
  InsertMasterFrameTargetVariablesBuilder(
    this._dataConnect, {
    required this.section,
    required this.density,
    required this.targetKgPerHour,
  });
  Deserializer<InsertMasterFrameTargetData> dataDeserializer = (dynamic json) =>
      InsertMasterFrameTargetData.fromJson(jsonDecode(json));
  Serializer<InsertMasterFrameTargetVariables> varsSerializer =
      (InsertMasterFrameTargetVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  MutationRef<InsertMasterFrameTargetData, InsertMasterFrameTargetVariables>
  ref() {
    InsertMasterFrameTargetVariables vars = InsertMasterFrameTargetVariables(
      section: section,
      density: density,
...
class InsertMasterFrameTargetMasterFrameTargetInsert {
  ...
  bool operator ==(Object other) {
    ...
    final InsertMasterFrameTargetMasterFrameTargetInsert otherTyped =
        other as InsertMasterFrameTargetMasterFrameTargetInsert;
  ...
  InsertMasterFrameTargetMasterFrameTargetInsert({required this.id});
}
...
class InsertMasterFrameTargetData {
  ...
  InsertMasterFrameTargetData.fromJson(dynamic json)
    : masterFrameTarget_insert =
          InsertMasterFrameTargetMasterFrameTargetInsert.fromJson(
            json['masterFrameTarget_insert'],
          );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
    ...
    final InsertMasterFrameTargetData otherTyped =
        other as InsertMasterFrameTargetData;
  ...
  InsertMasterFrameTargetData({required this.masterFrameTarget_insert});
}
...
class InsertMasterFrameTargetVariables {
  ...
  bool operator ==(Object other) {
    ...
    final InsertMasterFrameTargetVariables otherTyped =
        other as InsertMasterFrameTargetVariables;
  ...
  @override
  int get hashCode =>
      Object.hashAll([section.hashCode, density.hashCode, targetKgPerHour.hashCode]);
