...
class CreateFrameHealthReportVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  CreateFrameHealthReportVariablesBuilder submittedAt(Timestamp? t) {
   _submittedAt.value = t;
   return this;
  }

  CreateFrameHealthReportVariablesBuilder(this._dataConnect, {required  this.date,required  this.machineNumber,required  this.shift,required  this.totalMaintenanceDurationHours,required  this.createdBy,});
  Deserializer<CreateFrameHealthReportData> dataDeserializer = (dynamic json)  => CreateFrameHealthReportData.fromJson(jsonDecode(json));
  Serializer<CreateFrameHealthReportVariables> varsSerializer = (CreateFrameHealthReportVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateFrameHealthReportData, CreateFrameHealthReportVariables>> execute() {
    return ref().execute();
  }

  MutationRef<CreateFrameHealthReportData, CreateFrameHealthReportVariables> ref() {
    CreateFrameHealthReportVariables vars= CreateFrameHealthReportVariables(date: date,machineNumber: machineNumber,shift: shift,totalMaintenanceDurationHours: totalMaintenanceDurationHours,createdBy: createdBy,submittedAt: _submittedAt,);
    return _dataConnect.mutation("CreateFrameHealthReport", dataDeserializer, varsSerializer, vars);
  }
}
...
class CreateFrameHealthReportFrameHealthReportInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateFrameHealthReportFrameHealthReportInsert otherTyped = other as CreateFrameHealthReportFrameHealthReportInsert;
  ...
  CreateFrameHealthReportFrameHealthReportInsert({
    required this.id,
  });
}
...
class CreateFrameHealthReportData {
  ...
  frameHealthReport_insert = CreateFrameHealthReportFrameHealthReportInsert.fromJson(json['frameHealthReport_insert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
    ...
    final CreateFrameHealthReportData otherTyped = other as CreateFrameHealthReportData;
...
class CreateFrameHealthReportVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateFrameHealthReportVariables otherTyped = other as CreateFrameHealthReportVariables;
