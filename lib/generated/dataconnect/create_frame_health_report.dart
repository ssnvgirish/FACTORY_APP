...
class CreateFrameHealthReportVariablesBuilder {
  ...
  CreateFrameHealthReportVariablesBuilder(this._dataConnect, {required  this.date,required  this.machineNumber,required  this.shift,required  this.totalScore,required  this.percentage,required  this.createdBy,});
  ...
  MutationRef<CreateFrameHealthReportData, CreateFrameHealthReportVariables> ref() {
    CreateFrameHealthReportVariables vars= CreateFrameHealthReportVariables(date: date,machineNumber: machineNumber,shift: shift,totalScore: totalScore,percentage: percentage,createdBy: createdBy,submittedAt: _submittedAt,);
