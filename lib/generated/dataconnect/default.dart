...
part 'create_frame_maintenance_entry.dart';
...
part 'delete_frame_cleaning_report.dart';

part 'delete_frame_tools_count_report.dart';

part 'delete_frame_health_report.dart';

part 'delete_frame_production_details_report.dart';

part 'delete_frame_production_weight_report.dart';

part 'delete_frame_shift_packing_report.dart';

part 'delete_frame_writing_efficiency.dart';

part 'delete_frame_customer_rejection_report.dart';
...
part 'delete_scrap_cleaning_report.dart';

part 'delete_scrap_tools_count_report.dart';

part 'delete_scrap_machine_health_report.dart';

part 'delete_scrap_production_details_report.dart';

part 'delete_scrap_production_weight_report.dart';

part 'delete_scrap_writing_efficiency.dart';

part 'delete_scrap_quality_report.dart';
...
part 'create_sheet_maintenance_entry.dart';
...
part 'delete_sheet_cleaning_report.dart';

part 'delete_sheet_tools_count_report.dart';

part 'delete_sheet_health_report.dart';

part 'delete_sheet_production_details_report.dart';

part 'delete_sheet_running_feet_report.dart';

part 'delete_sheet_shift_packing_report.dart';

part 'delete_sheet_writing_efficiency.dart';

part 'delete_sheet_customer_rejection_report.dart';
...
class DefaultConnector {
  ...
  CreateFrameHealthReportVariablesBuilder createFrameHealthReport ({required DateTime date, required String machineNumber, required String shift, required double totalMaintenanceDurationHours, required String createdBy, }) {
    return CreateFrameHealthReportVariablesBuilder(dataConnect, date: date,machineNumber: machineNumber,shift: shift,totalMaintenanceDurationHours: totalMaintenanceDurationHours,createdBy: createdBy,);
  }
  
  
  CreateFrameMaintenanceEntryVariablesBuilder createFrameMaintenanceEntry ({required CreateFrameMaintenanceEntryVariablesReportId reportId, required String maintenanceItem, required Timestamp startTime, required Timestamp endTime, required String personDoingMaintenance, required String description, required double durationHours, }) {
    return CreateFrameMaintenanceEntryVariablesBuilder(dataConnect, reportId: reportId,maintenanceItem: maintenanceItem,startTime: startTime,endTime: endTime,personDoingMaintenance: personDoingMaintenance,description: description,durationHours: durationHours,);
  }
  ...
  DeleteFrameCleaningReportVariablesBuilder deleteFrameCleaningReport ({required DeleteFrameCleaningReportVariablesId id, }) {
    return DeleteFrameCleaningReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameToolsCountReportVariablesBuilder deleteFrameToolsCountReport ({required DeleteFrameToolsCountReportVariablesId id, }) {
    return DeleteFrameToolsCountReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameHealthReportVariablesBuilder deleteFrameHealthReport ({required String id, }) {
    return DeleteFrameHealthReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameProductionDetailsReportVariablesBuilder deleteFrameProductionDetailsReport ({required String id, }) {
    return DeleteFrameProductionDetailsReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameProductionWeightReportVariablesBuilder deleteFrameProductionWeightReport ({required DeleteFrameProductionWeightReportVariablesId id, }) {
    return DeleteFrameProductionWeightReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameShiftPackingReportVariablesBuilder deleteFrameShiftPackingReport ({required String id, }) {
    return DeleteFrameShiftPackingReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameWritingEfficiencyVariablesBuilder deleteFrameWritingEfficiency ({required DeleteFrameWritingEfficiencyVariablesId id, }) {
    return DeleteFrameWritingEfficiencyVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteFrameCustomerRejectionReportVariablesBuilder deleteFrameCustomerRejectionReport ({required String id, }) {
    return DeleteFrameCustomerRejectionReportVariablesBuilder(dataConnect, id: id,);
  }
  ...
  InsertMasterFrameTargetVariablesBuilder insertMasterFrameTarget ({required String section, required String density, required double targetKgPerHour, }) {
    return InsertMasterFrameTargetVariablesBuilder(dataConnect, section: section,density: density,targetKgPerHour: targetKgPerHour,);
  }
  
  
  UpdateMasterFrameTargetVariablesBuilder updateMasterFrameTarget ({required UpdateMasterFrameTargetVariablesId id, required String section, required String density, required double targetKgPerHour, }) {
    return UpdateMasterFrameTargetVariablesBuilder(dataConnect, id: id,section: section,density: density,targetKgPerHour: targetKgPerHour,);
  }
  ...
  InsertMasterSheetTargetVariablesBuilder insertMasterSheetTarget ({required String thickness, required String density, required double targetFeetPerHour, }) {
    return InsertMasterSheetTargetVariablesBuilder(dataConnect, thickness: thickness,density: density,targetFeetPerHour: targetFeetPerHour,);
  }
  
  
  UpdateMasterSheetTargetVariablesBuilder updateMasterSheetTarget ({required UpdateMasterSheetTargetVariablesId id, required String thickness, required String density, required double targetFeetPerHour, }) {
    return UpdateMasterSheetTargetVariablesBuilder(dataConnect, id: id,thickness: thickness,density: density,targetFeetPerHour: targetFeetPerHour,);
  }
  ...
  DeleteScrapCleaningReportVariablesBuilder deleteScrapCleaningReport ({required DeleteScrapCleaningReportVariablesId id, }) {
    return DeleteScrapCleaningReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapToolsCountReportVariablesBuilder deleteScrapToolsCountReport ({required DeleteScrapToolsCountReportVariablesId id, }) {
    return DeleteScrapToolsCountReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapMachineHealthReportVariablesBuilder deleteScrapMachineHealthReport ({required String id, }) {
    return DeleteScrapMachineHealthReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapProductionDetailsReportVariablesBuilder deleteScrapProductionDetailsReport ({required String id, }) {
    return DeleteScrapProductionDetailsReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapProductionWeightReportVariablesBuilder deleteScrapProductionWeightReport ({required DeleteScrapProductionWeightReportVariablesId id, }) {
    return DeleteScrapProductionWeightReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapWritingEfficiencyVariablesBuilder deleteScrapWritingEfficiency ({required DeleteScrapWritingEfficiencyVariablesId id, }) {
    return DeleteScrapWritingEfficiencyVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteScrapQualityReportVariablesBuilder deleteScrapQualityReport ({required DeleteScrapQualityReportVariablesId id, }) {
    return DeleteScrapQualityReportVariablesBuilder(dataConnect, id: id,);
  }
  ...
  CreateSheetHealthReportVariablesBuilder createSheetHealthReport ({required DateTime date, required String machineNumber, required String shift, required double totalMaintenanceDurationHours, required String createdBy, }) {
    return CreateSheetHealthReportVariablesBuilder(dataConnect, date: date,machineNumber: machineNumber,shift: shift,totalMaintenanceDurationHours: totalMaintenanceDurationHours,createdBy: createdBy,);
  }
  
  
  CreateSheetMaintenanceEntryVariablesBuilder createSheetMaintenanceEntry ({required CreateSheetMaintenanceEntryVariablesReportId reportId, required String maintenanceItem, required Timestamp startTime, required Timestamp endTime, required String personDoingMaintenance, required String description, required double durationHours, }) {
    return CreateSheetMaintenanceEntryVariablesBuilder(dataConnect, reportId: reportId,maintenanceItem: maintenanceItem,startTime: startTime,endTime: endTime,personDoingMaintenance: personDoingMaintenance,description: description,durationHours: durationHours,);
  }
  ...
  DeleteSheetCleaningReportVariablesBuilder deleteSheetCleaningReport ({required DeleteSheetCleaningReportVariablesId id, }) {
    return DeleteSheetCleaningReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetToolsCountReportVariablesBuilder deleteSheetToolsCountReport ({required DeleteSheetToolsCountReportVariablesId id, }) {
    return DeleteSheetToolsCountReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetHealthReportVariablesBuilder deleteSheetHealthReport ({required String id, }) {
    return DeleteSheetHealthReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetProductionDetailsReportVariablesBuilder deleteSheetProductionDetailsReport ({required String id, }) {
    return DeleteSheetProductionDetailsReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetRunningFeetReportVariablesBuilder deleteSheetRunningFeetReport ({required DeleteSheetRunningFeetReportVariablesId id, }) {
    return DeleteSheetRunningFeetReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetShiftPackingReportVariablesBuilder deleteSheetShiftPackingReport ({required String id, }) {
    return DeleteSheetShiftPackingReportVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetWritingEfficiencyVariablesBuilder deleteSheetWritingEfficiency ({required DeleteSheetWritingEfficiencyVariablesId id, }) {
    return DeleteSheetWritingEfficiencyVariablesBuilder(dataConnect, id: id,);
  }
  
  
  DeleteSheetCustomerRejectionReportVariablesBuilder deleteSheetCustomerRejectionReport ({required String id, }) {
    return DeleteSheetCustomerRejectionReportVariablesBuilder(dataConnect, id: id,);
  }
