...
class DefaultConnector {
  ...
  InsertMasterMachineVariablesBuilder insertMasterMachine({
    required String name,
    required String type,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterMachineVariablesBuilder(
      dataConnect,
      name: name,
      type: type,
      sortOrder: sortOrder,
  ...
  UpdateMasterMachineVariablesBuilder updateMasterMachine({
    required UpdateMasterMachineVariablesId id,
    required String name,
    required String type,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterMachineVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      type: type,
  ...
  DeleteMasterMachineVariablesBuilder deleteMasterMachine({
    required DeleteMasterMachineVariablesId id,
  }) {
  ...
  InsertMasterShiftVariablesBuilder insertMasterShift({
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterShiftVariablesBuilder(
      dataConnect,
      name: name,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterShiftVariablesBuilder updateMasterShift({
    required UpdateMasterShiftVariablesId id,
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterShiftVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      sortOrder: sortOrder,
  ...
  DeleteMasterShiftVariablesBuilder deleteMasterShift({
    required DeleteMasterShiftVariablesId id,
  }) {
  ...
  InsertMasterRoleVariablesBuilder insertMasterRole({
    required String code,
    required String displayName,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterRoleVariablesBuilder(
      dataConnect,
      code: code,
  ...
  UpdateMasterRoleVariablesBuilder updateMasterRole({
    required UpdateMasterRoleVariablesId id,
    required String code,
    required String displayName,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterRoleVariablesBuilder(
      dataConnect,
      id: id,
      code: code,
      displayName: displayName,
  ...
  DeleteMasterRoleVariablesBuilder deleteMasterRole({
    required DeleteMasterRoleVariablesId id,
  }) {
  ...
  InsertMasterFrameSectionVariablesBuilder insertMasterFrameSection({
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterFrameSectionVariablesBuilder(
      dataConnect,
      name: name,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterFrameSectionVariablesBuilder updateMasterFrameSection({
    required UpdateMasterFrameSectionVariablesId id,
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterFrameSectionVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      sortOrder: sortOrder,
  ...
  DeleteMasterFrameSectionVariablesBuilder deleteMasterFrameSection({
    required DeleteMasterFrameSectionVariablesId id,
  }) {
  ...
  InsertMasterFrameDensityVariablesBuilder insertMasterFrameDensity({
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterFrameDensityVariablesBuilder(
      dataConnect,
      value: value,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterFrameDensityVariablesBuilder updateMasterFrameDensity({
    required UpdateMasterFrameDensityVariablesId id,
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterFrameDensityVariablesBuilder(
      dataConnect,
      id: id,
      value: value,
      sortOrder: sortOrder,
  ...
  DeleteMasterFrameDensityVariablesBuilder deleteMasterFrameDensity({
    required DeleteMasterFrameDensityVariablesId id,
  }) {
  ...
  InsertMasterFrameColorVariablesBuilder insertMasterFrameColor({
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterFrameColorVariablesBuilder(
      dataConnect,
      name: name,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterFrameColorVariablesBuilder updateMasterFrameColor({
    required UpdateMasterFrameColorVariablesId id,
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterFrameColorVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      sortOrder: sortOrder,
  ...
  DeleteMasterFrameColorVariablesBuilder deleteMasterFrameColor({
    required DeleteMasterFrameColorVariablesId id,
  }) {
  ...
  InsertMasterSheetThicknessVariablesBuilder insertMasterSheetThickness({
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterSheetThicknessVariablesBuilder(
      dataConnect,
      value: value,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterSheetThicknessVariablesBuilder updateMasterSheetThickness({
    required UpdateMasterSheetThicknessVariablesId id,
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterSheetThicknessVariablesBuilder(
      dataConnect,
      id: id,
      value: value,
      sortOrder: sortOrder,
  ...
  DeleteMasterSheetThicknessVariablesBuilder deleteMasterSheetThickness({
    required DeleteMasterSheetThicknessVariablesId id,
  }) {
  ...
  InsertMasterSheetDensityVariablesBuilder insertMasterSheetDensity({
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterSheetDensityVariablesBuilder(
      dataConnect,
      value: value,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterSheetDensityVariablesBuilder updateMasterSheetDensity({
    required UpdateMasterSheetDensityVariablesId id,
    required String value,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterSheetDensityVariablesBuilder(
      dataConnect,
      id: id,
      value: value,
      sortOrder: sortOrder,
  ...
  DeleteMasterSheetDensityVariablesBuilder deleteMasterSheetDensity({
    required DeleteMasterSheetDensityVariablesId id,
  }) {
  ...
  InsertMasterSheetColorVariablesBuilder insertMasterSheetColor({
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterSheetColorVariablesBuilder(
      dataConnect,
      name: name,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterSheetColorVariablesBuilder updateMasterSheetColor({
    required UpdateMasterSheetColorVariablesId id,
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterSheetColorVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      sortOrder: sortOrder,
  ...
  DeleteMasterSheetColorVariablesBuilder deleteMasterSheetColor({
    required DeleteMasterSheetColorVariablesId id,
  }) {
  ...
  InsertMasterMaintenanceItemVariablesBuilder insertMasterMaintenanceItem({
    required String name,
    required String category,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterMaintenanceItemVariablesBuilder(
      dataConnect,
      name: name,
      category: category,
      sortOrder: sortOrder,
  ...
  UpdateMasterMaintenanceItemVariablesBuilder updateMasterMaintenanceItem({
    required UpdateMasterMaintenanceItemVariablesId id,
    required String name,
    required String category,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterMaintenanceItemVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      category: category,
  ...
  DeleteMasterMaintenanceItemVariablesBuilder deleteMasterMaintenanceItem({
    required DeleteMasterMaintenanceItemVariablesId id,
  }) {
  ...
  InsertMasterScrapProductVariablesBuilder insertMasterScrapProduct({
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return InsertMasterScrapProductVariablesBuilder(
      dataConnect,
      name: name,
      sortOrder: sortOrder,
      isActive: isActive,
  ...
  UpdateMasterScrapProductVariablesBuilder updateMasterScrapProduct({
    required UpdateMasterScrapProductVariablesId id,
    required String name,
    required int sortOrder,
    required bool isActive,
  }) {
    return UpdateMasterScrapProductVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      sortOrder: sortOrder,
  ...
  DeleteMasterScrapProductVariablesBuilder deleteMasterScrapProduct({
    required DeleteMasterScrapProductVariablesId id,
  }) {
  ...
  InsertMasterFrameWeightVariablesBuilder insertMasterFrameWeight({
    required String section,
    required String density,
    required double weightPerFoot,
  }) {
    return InsertMasterFrameWeightVariablesBuilder(
      dataConnect,
      section: section,
      density: density,
  ...
  UpdateMasterFrameWeightVariablesBuilder updateMasterFrameWeight({
    required UpdateMasterFrameWeightVariablesId id,
    required String section,
    required String density,
    required double weightPerFoot,
  }) {
    return UpdateMasterFrameWeightVariablesBuilder(
      dataConnect,
      id: id,
      section: section,
      density: density,
  ...
  DeleteMasterFrameWeightVariablesBuilder deleteMasterFrameWeight({
    required DeleteMasterFrameWeightVariablesId id,
  }) {
  ...
  InsertMasterSheetWeightVariablesBuilder insertMasterSheetWeight({
    required String thickness,
    required String density,
    required double weightPerSqft,
  }) {
    return InsertMasterSheetWeightVariablesBuilder(
      dataConnect,
      thickness: thickness,
      density: density,
  ...
  UpdateMasterSheetWeightVariablesBuilder updateMasterSheetWeight({
    required UpdateMasterSheetWeightVariablesId id,
    required String thickness,
    required String density,
    required double weightPerSqft,
  }) {
    return UpdateMasterSheetWeightVariablesBuilder(
      dataConnect,
      id: id,
      thickness: thickness,
      density: density,
  ...
  DeleteMasterSheetWeightVariablesBuilder deleteMasterSheetWeight({
    required DeleteMasterSheetWeightVariablesId id,
  }) {
  ...
  DeleteMasterFrameTargetVariablesBuilder deleteMasterFrameTarget({
    required DeleteMasterFrameTargetVariablesId id,
  }) {
  ...
  DeleteMasterSheetTargetVariablesBuilder deleteMasterSheetTarget({
    required DeleteMasterSheetTargetVariablesId id,
  }) {
  ...
  InsertMasterSalaryWeightageVariablesBuilder insertMasterSalaryWeightage({
    required String variable,
    required String label,
    required String category,
    required double percentage,
  }) {
    return InsertMasterSalaryWeightageVariablesBuilder(
      dataConnect,
      variable: variable,
      label: label,
      category: category,
  ...
  UpdateMasterSalaryWeightageVariablesBuilder updateMasterSalaryWeightage({
    required UpdateMasterSalaryWeightageVariablesId id,
    required String variable,
    required String label,
    required String category,
    required double percentage,
  }) {
    return UpdateMasterSalaryWeightageVariablesBuilder(
      dataConnect,
      id: id,
      variable: variable,
      label: label,
  ...
  DeleteMasterSalaryWeightageVariablesBuilder deleteMasterSalaryWeightage({
    required DeleteMasterSalaryWeightageVariablesId id,
  }) {
  ...
  InsertMasterScrapTargetVariablesBuilder insertMasterScrapTarget({
    required String product,
    required double targetKgPerHour,
  }) {
    return InsertMasterScrapTargetVariablesBuilder(
      dataConnect,
      product: product,
      targetKgPerHour: targetKgPerHour,
    );
  ...
  UpdateMasterScrapTargetVariablesBuilder updateMasterScrapTarget({
    required UpdateMasterScrapTargetVariablesId id,
    required String product,
    required double targetKgPerHour,
  }) {
    return UpdateMasterScrapTargetVariablesBuilder(
      dataConnect,
      id: id,
      product: product,
      targetKgPerHour: targetKgPerHour,
  ...
  DeleteMasterScrapTargetVariablesBuilder deleteMasterScrapTarget({
    required DeleteMasterScrapTargetVariablesId id,
  }) {
  ...
  UpdateUserVariablesBuilder updateUser({
    required UpdateUserVariablesId id,
    required String name,
    required String phone,
    required List<String> roles,
    required List<String> assignedMachines,
    ...
    return UpdateUserVariablesBuilder(
      dataConnect,
      id: id,
      name: name,
      phone: phone,
  ...
  ToggleUserActiveVariablesBuilder toggleUserActive({
    required ToggleUserActiveVariablesId id,
    required bool isActive,
  }) {
    return ToggleUserActiveVariablesBuilder(
      dataConnect,
      id: id,
      isActive: isActive,
    );
  ...
  GetUserByIdVariablesBuilder getUserById({
    required GetUserByIdVariablesId id,
  }) {
  ...
  CreateSalaryCalculationVariablesBuilder createSalaryCalculation({
    ...
    return CreateSalaryCalculationVariablesBuilder(
      dataConnect,
  ...
  UpdateSalaryCalculationVariablesBuilder updateSalaryCalculation({
    required UpdateSalaryCalculationVariablesId id,
    required String operatorId,
    required String operatorName,
    required int year,
    required int month,
    ...
    return UpdateSalaryCalculationVariablesBuilder(
      dataConnect,
      id: id,
      operatorId: operatorId,
      operatorName: operatorName,
  ...
  GetSalaryCalculationVariablesBuilder getSalaryCalculation({
    required String operatorId,
    required int year,
    required int month,
  }) {
    return GetSalaryCalculationVariablesBuilder(
      dataConnect,
      operatorId: operatorId,
      year: year,
      month: month,
  ...
  ListAllSalaryCalculationsForMonthVariablesBuilder
  listAllSalaryCalculationsForMonth({required int year, required int month}) {
    return ListAllSalaryCalculationsForMonthVariablesBuilder(
      dataConnect,
      year: year,
      month: month,
    );
  ...
  CreateScrapCleaningReportVariablesBuilder createScrapCleaningReport({
    required DateTime date,
    required String machineNumber,
    required int machineCondition,
    required int groundCondition,
    required int totalScore,
    required double percentage,
    required String createdBy,
  }) {
    return CreateScrapCleaningReportVariablesBuilder(
      dataConnect,
      date: date,
  ...
  CreateScrapToolsCountReportVariablesBuilder createScrapToolsCountReport({
    required DateTime date,
    required String machineNumber,
    required int totalToolsGiven,
    required int totalToolsAvailable,
    required double percentageAvailable,
    required String createdBy,
  }) {
    return CreateScrapToolsCountReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
  ...
  CreateScrapMachineHealthReportVariablesBuilder
  createScrapMachineHealthReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalMaintenanceDurationHours,
    required String createdBy,
  }) {
    return CreateScrapMachineHealthReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateScrapMaintenanceEntryVariablesBuilder createScrapMaintenanceEntry({
    required CreateScrapMaintenanceEntryVariablesReportId reportId,
    required String maintenanceItem,
    required Timestamp startTime,
    required Timestamp endTime,
    required String personDoingMaintenance,
    required String description,
    required double durationHours,
  }) {
    return CreateScrapMaintenanceEntryVariablesBuilder(
      dataConnect,
      reportId: reportId,
  ...
  ListScrapMachineHealthReportsVariablesBuilder
  listScrapMachineHealthReports() {
    return ListScrapMachineHealthReportsVariablesBuilder(dataConnect);
  }

  CreateScrapProductionDetailsReportVariablesBuilder
  createScrapProductionDetailsReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalProductionWeight,
    required String createdBy,
  }) {
    return CreateScrapProductionDetailsReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateScrapProductionLineItemVariablesBuilder createScrapProductionLineItem({
    required CreateScrapProductionLineItemVariablesReportId reportId,
    required String product,
    required double weightPerBag,
    required int totalBags,
    required double totalWeight,
  }) {
    return CreateScrapProductionLineItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      product: product,
  ...
  ListScrapProductionDetailsReportsVariablesBuilder
  listScrapProductionDetailsReports() {
    return ListScrapProductionDetailsReportsVariablesBuilder(dataConnect);
  }

  GetScrapProductionDetailsReportVariablesBuilder
  getScrapProductionDetailsReport({
    required String machineNumber,
    required DateTime date,
    required String shift,
  }) {
    return GetScrapProductionDetailsReportVariablesBuilder(
      dataConnect,
      machineNumber: machineNumber,
      date: date,
      shift: shift,
  ...
  createScrapProductionWeightReport({
    ...
    required String shift,
    required double totalProductionWeight,
    required double maintenanceWeight,
    required double totalWeight,
  ...
  ListScrapProductionWeightReportsVariablesBuilder
  listScrapProductionWeightReports() {
    return ListScrapProductionWeightReportsVariablesBuilder(dataConnect);
  }

  CreateScrapWritingEfficiencyVariablesBuilder createScrapWritingEfficiency({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required Timestamp shiftEndTime,
    required int score,
    required String operatorId,
  }) {
    return CreateScrapWritingEfficiencyVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  ListScrapReportWritingEfficiencyVariablesBuilder
  listScrapReportWritingEfficiency() {
    return ListScrapReportWritingEfficiencyVariablesBuilder(dataConnect);
  }

  CreateScrapQualityReportVariablesBuilder createScrapQualityReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required String product,
    ...
    return CreateScrapQualityReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateScrapSalaryCalculationVariablesBuilder createScrapSalaryCalculation({
    required String operatorId,
    required String operatorName,
    required int year,
    required int month,
    ...
    return CreateScrapSalaryCalculationVariablesBuilder(
      dataConnect,
      operatorId: operatorId,
      operatorName: operatorName,
      year: year,
  ...
  GetScrapSalaryCalculationVariablesBuilder getScrapSalaryCalculation({
    required String operatorId,
    required int year,
    required int month,
  }) {
    return GetScrapSalaryCalculationVariablesBuilder(
      dataConnect,
      operatorId: operatorId,
      year: year,
      month: month,
  ...
  GetScrapMonthlyAggregatesVariablesBuilder getScrapMonthlyAggregates({
    required String machineNumber,
    required DateTime startDate,
    required DateTime endDate,
  }) {
    return GetScrapMonthlyAggregatesVariablesBuilder(
      dataConnect,
      machineNumber: machineNumber,
      startDate: startDate,
      endDate: endDate,
  ...
  CreateSheetCleaningReportVariablesBuilder createSheetCleaningReport({
    required DateTime date,
    required String machineNumber,
    required int machineCondition,
    required int groundCondition,
    required int mouldCondition,
    required int totalScore,
    required double percentage,
    required String createdBy,
  }) {
    return CreateSheetCleaningReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      machineCondition: machineCondition,
  ...
  CreateSheetToolsCountReportVariablesBuilder createSheetToolsCountReport({
    required DateTime date,
    required String machineNumber,
    required int totalToolsGiven,
    required int totalToolsAvailable,
    ...
    return CreateSheetToolsCountReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      totalToolsGiven: totalToolsGiven,
  ...
  CreateSheetHealthReportVariablesBuilder createSheetHealthReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalMaintenanceDurationHours,
    ...
    return CreateSheetHealthReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateSheetMaintenanceEntryVariablesBuilder createSheetMaintenanceEntry({
    required CreateSheetMaintenanceEntryVariablesReportId reportId,
    required String maintenanceItem,
    required Timestamp startTime,
    required Timestamp endTime,
    required String personDoingMaintenance,
    ...
    return CreateSheetMaintenanceEntryVariablesBuilder(
      dataConnect,
      reportId: reportId,
      maintenanceItem: maintenanceItem,
      startTime: startTime,
  ...
  CreateSheetProductionDetailsReportVariablesBuilder
  createSheetProductionDetailsReport({
    ...
    required double totalWeight,
    required double totalRunningFeet,
    required String createdBy,
  }) {
    return CreateSheetProductionDetailsReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateSheetProductionLineItemVariablesBuilder createSheetProductionLineItem({
    required CreateSheetProductionLineItemVariablesReportId reportId,
    required String thickness,
    required String density,
    ...
    required double perPieceWeight,
    required double totalWeight,
    required double totalRunningFeet,
  }) {
    return CreateSheetProductionLineItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      thickness: thickness,
      density: density,
  ...
  ListSheetProductionDetailsReportsVariablesBuilder
  listSheetProductionDetailsReports() {
    return ListSheetProductionDetailsReportsVariablesBuilder(dataConnect);
  }

  GetSheetProductionDetailsReportVariablesBuilder
  getSheetProductionDetailsReport({
    required String machineNumber,
    required DateTime date,
    required String shift,
  }) {
    return GetSheetProductionDetailsReportVariablesBuilder(
      dataConnect,
      machineNumber: machineNumber,
      date: date,
      shift: shift,
  ...
  CreateSheetRunningFeetReportVariablesBuilder createSheetRunningFeetReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double productionRunningFeet,
    required double maintenanceRunningFeet,
    required double totalProductionRunningFeet,
    required double targetRunningFeet,
    required double efficiencyPercentage,
    required String createdBy,
  }) {
    return CreateSheetRunningFeetReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateSheetShiftPackingReportVariablesBuilder createSheetShiftPackingReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalRejectedRunningFeet,
    required double qualityAcceptancePercentage,
    required double packingEfficiency,
    required String createdBy,
  }) {
    return CreateSheetShiftPackingReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateSheetPackingLineItemVariablesBuilder createSheetPackingLineItem({
    required CreateSheetPackingLineItemVariablesReportId reportId,
    required String thickness,
    required String density,
    required String color,
    required double length,
    ...
    required double perPieceWeight,
    required double runningFeetPerItem,
    required int packed,
    required int onlySanding,
    required int sandingAndPacked,
    required int rejectedQuality,
  }) {
  ...
  CreateSheetWritingEfficiencyVariablesBuilder createSheetWritingEfficiency({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required Timestamp shiftEndTime,
    ...
    return CreateSheetWritingEfficiencyVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateSheetCustomerRejectionReportVariablesBuilder
  createSheetCustomerRejectionReport({
    required DateTime originalProductionDate,
    required String machineNumber,
    required String shift,
    required double totalRejectedRunningFeet,
    required String createdBy,
  }) {
    return CreateSheetCustomerRejectionReportVariablesBuilder(
      dataConnect,
  ...
  createSheetCustomerRejectionItem({
    required CreateSheetCustomerRejectionItemVariablesReportId reportId,
    required String thickness,
    required String density,
    required String color,
    required double length,
    ...
    return CreateSheetCustomerRejectionItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      thickness: thickness,
      density: density,
  ...
  ListSheetCustomerRejectionReportsVariablesBuilder
  listSheetCustomerRejectionReports() {
    return ListSheetCustomerRejectionReportsVariablesBuilder(dataConnect);
  }

  CreateFrameCleaningReportVariablesBuilder createFrameCleaningReport({
    required DateTime date,
    required String machineNumber,
    required int machineCondition,
    required int groundCondition,
    ...
    return CreateFrameCleaningReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      machineCondition: machineCondition,
  ...
  CreateFrameToolsCountReportVariablesBuilder createFrameToolsCountReport({
    required DateTime date,
    required String machineNumber,
    required int totalToolsGiven,
    required int totalToolsAvailable,
    ...
    return CreateFrameToolsCountReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      totalToolsGiven: totalToolsGiven,
  ...
  CreateFrameHealthReportVariablesBuilder createFrameHealthReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalMaintenanceDurationHours,
    ...
    return CreateFrameHealthReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateFrameMaintenanceEntryVariablesBuilder createFrameMaintenanceEntry({
    required CreateFrameMaintenanceEntryVariablesReportId reportId,
    required String maintenanceItem,
    required Timestamp startTime,
    required Timestamp endTime,
    required String personDoingMaintenance,
    ...
    return CreateFrameMaintenanceEntryVariablesBuilder(
      dataConnect,
      reportId: reportId,
      maintenanceItem: maintenanceItem,
      startTime: startTime,
  ...
  CreateFrameProductionDetailsReportVariablesBuilder
  createFrameProductionDetailsReport({
    ...
    return CreateFrameProductionDetailsReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateFrameProductionLineItemVariablesBuilder createFrameProductionLineItem({
    required CreateFrameProductionLineItemVariablesReportId reportId,
    required String section,
    required String density,
    required String color,
    required double length,
    ...
    return CreateFrameProductionLineItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      section: section,
      density: density,
  ...
  ListFrameProductionDetailsReportsVariablesBuilder
  listFrameProductionDetailsReports() {
    return ListFrameProductionDetailsReportsVariablesBuilder(dataConnect);
  }

  GetFrameProductionDetailsReportVariablesBuilder
  getFrameProductionDetailsReport({
    required String machineNumber,
    required DateTime date,
    required String shift,
  }) {
    return GetFrameProductionDetailsReportVariablesBuilder(
      dataConnect,
      machineNumber: machineNumber,
      date: date,
      shift: shift,
  ...
  CreateFrameProductionWeightReportVariablesBuilder
  createFrameProductionWeightReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double productionWeight,
    required double maintenanceWeight,
    required double totalProductionWeight,
    required double targetWeight,
    required double efficiencyPercentage,
    ...
    return CreateFrameProductionWeightReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  ListFrameProductionWeightReportsVariablesBuilder
  listFrameProductionWeightReports() {
    return ListFrameProductionWeightReportsVariablesBuilder(dataConnect);
  }

  CreateFrameShiftPackingReportVariablesBuilder createFrameShiftPackingReport({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required double totalRejectedWeight,
    required double qualityAcceptancePercentage,
    required double packingEfficiency,
    required String createdBy,
  }) {
    return CreateFrameShiftPackingReportVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateFramePackingLineItemVariablesBuilder createFramePackingLineItem({
    required CreateFramePackingLineItemVariablesReportId reportId,
    required String section,
    required String density,
    required String color,
    required double length,
    ...
    return CreateFramePackingLineItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      section: section,
      density: density,
  ...
  CreateFrameWritingEfficiencyVariablesBuilder createFrameWritingEfficiency({
    required DateTime date,
    required String machineNumber,
    required String shift,
    required Timestamp shiftEndTime,
    ...
    return CreateFrameWritingEfficiencyVariablesBuilder(
      dataConnect,
      date: date,
      machineNumber: machineNumber,
      shift: shift,
  ...
  CreateFrameCustomerRejectionReportVariablesBuilder
  createFrameCustomerRejectionReport({
    ...
    return CreateFrameCustomerRejectionReportVariablesBuilder(
      dataConnect,
      originalProductionDate: originalProductionDate,
  ...
  createFrameCustomerRejectionItem({
    required CreateFrameCustomerRejectionItemVariablesReportId reportId,
    required String section,
    required String density,
    required String color,
    required double length,
    ...
    return CreateFrameCustomerRejectionItemVariablesBuilder(
      dataConnect,
      reportId: reportId,
      section: section,
      density: density,
  ...
  ListFrameCustomerRejectionReportsVariablesBuilder
