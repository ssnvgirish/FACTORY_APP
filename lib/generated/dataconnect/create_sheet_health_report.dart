...
class CreateSheetHealthReportVariablesBuilder {
  ...
  CreateSheetHealthReportVariablesBuilder(this._dataConnect, {required  this.date,required  this.machineNumber,required  this.shift,required  this.totalMaintenanceDurationHours,required  this.createdBy,});
  ...
  MutationRef<CreateSheetHealthReportData, CreateSheetHealthReportVariables> ref() {
    CreateSheetHealthReportVariables vars= CreateSheetHealthReportVariables(date: date,machineNumber: machineNumber,shift: shift,totalMaintenanceDurationHours: totalMaintenanceDurationHours,createdBy: createdBy,submittedAt: _submittedAt,);
