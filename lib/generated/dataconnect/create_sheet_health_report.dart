...
class CreateSheetHealthReportVariablesBuilder {
  ...
  CreateSheetHealthReportVariablesBuilder(
    this._dataConnect, {
    required this.date,
  ...
  Deserializer<CreateSheetHealthReportData> dataDeserializer = (dynamic json) =>
      CreateSheetHealthReportData.fromJson(jsonDecode(json));
  Serializer<CreateSheetHealthReportVariables> varsSerializer =
      (CreateSheetHealthReportVariables vars) => jsonEncode(vars.toJson());
  Future<
    OperationResult<
  ...
  MutationRef<CreateSheetHealthReportData, CreateSheetHealthReportVariables>
  ref() {
    CreateSheetHealthReportVariables vars = CreateSheetHealthReportVariables(
      date: date,
...
class CreateSheetHealthReportSheetHealthReportInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSheetHealthReportSheetHealthReportInsert otherTyped =
        other as CreateSheetHealthReportSheetHealthReportInsert;
  ...
  CreateSheetHealthReportSheetHealthReportInsert({required this.id});
}
...
class CreateSheetHealthReportData {
  ...
  CreateSheetHealthReportData.fromJson(dynamic json)
    : sheetHealthReport_insert =
          CreateSheetHealthReportSheetHealthReportInsert.fromJson(
            json['sheetHealthReport_insert'],
          );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
    ...
    final CreateSheetHealthReportData otherTyped =
        other as CreateSheetHealthReportData;
  ...
  CreateSheetHealthReportData({required this.sheetHealthReport_insert});
}
...
class CreateSheetHealthReportVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateSheetHealthReportVariables otherTyped =
        other as CreateSheetHealthReportVariables;
